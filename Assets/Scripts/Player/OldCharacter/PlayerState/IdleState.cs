...
public class IdleState :  IState
{
    ...
    public IdleState(PlayerBehaviour playerBehaviour, StateMachine stateMachine) // Doble constructor, porque no hereda de monobehavoir
    {
    ...
    public void Enter()
    {
        ...
        _playerBehaviour.SetMovementInput(Vector2.zero); //Freezeamos al pj al entrar a este estado.
        _playerBehaviour.SetMovementEnabled(true);
    ...
    public void Update()
    {
        ...
        _playerBehaviour.SetMovementInput(Vector2.zero);
