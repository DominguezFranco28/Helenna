...
public class OldPlayerController : MonoBehaviour , IHasStateMachine
{
    ...
    public OldStateMachine StateMachine { get; private set; }
    public IState CurrentState => StateMachine.CurrentState; //expongo lectura de la maquina para que el charactermanager sepa en que estado esta cada pj.
    ...
    private void Start()
    {
        StateMachine = new OldStateMachine(_playerBehaviour, _triggerDetector, _grabObject, _anchorDetector, _rexController);
